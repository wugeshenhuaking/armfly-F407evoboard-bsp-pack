...
#define T_PEN_GPIO_PIN                  SYS_GPIO_PIN1
#define T_PEN_GPIO_CLK_ENABLE()         do{ RCC->AHB1ENR |= 1 << 1; }while(0)   /* 所在IO口时钟使能 */

#define T_CS_GPIO_PORT                  GPIOC
#define T_CS_GPIO_PIN                   SYS_GPIO_PIN13
#define T_CS_GPIO_CLK_ENABLE()          do{ RCC->AHB1ENR |= 1 << 2; }while(0)   /* 所在IO口时钟使能 */

#define T_MISO_GPIO_PORT                GPIOB
#define T_MISO_GPIO_PIN                 SYS_GPIO_PIN2
#define T_MISO_GPIO_CLK_ENABLE()        do{ RCC->AHB1ENR |= 1 << 1; }while(0)   /* 所在IO口时钟使能 */

#define T_MOSI_GPIO_PORT                GPIOF
#define T_MOSI_GPIO_PIN                 SYS_GPIO_PIN11
#define T_MOSI_GPIO_CLK_ENABLE()        do{ RCC->AHB1ENR |= 1 << 5; }while(0)   /* 所在IO口时钟使能 */

#define T_CLK_GPIO_PORT                 GPIOB
#define T_CLK_GPIO_PIN                  SYS_GPIO_PIN0
#define T_CLK_GPIO_CLK_ENABLE()         do{ RCC->AHB1ENR |= 1 << 2; }while(0)   /* 所在IO口时钟使能 */

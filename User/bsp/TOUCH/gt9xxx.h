...
#define GT9XXX_RST_GPIO_PIN             SYS_GPIO_PIN13
#define GT9XXX_RST_GPIO_CLK_ENABLE()    do{ RCC->AHB1ENR |= 1 << 2; }while(0)   /* PC口时钟使能 */

#define GT9XXX_INT_GPIO_PORT            GPIOB
#define GT9XXX_INT_GPIO_PIN             SYS_GPIO_PIN1
#define GT9XXX_INT_GPIO_CLK_ENABLE()    do{ RCC->AHB1ENR |= 1 << 1; }while(0)   /* PB口时钟使能 */
